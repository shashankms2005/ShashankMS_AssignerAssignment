...
function MovieDetails() {
    ...
    return (
        ...
        <div className="min-h-[80vh] w-[60vw] rounded-lg p-5 mt-2 bg-gradient-to-b from-[#170B2E]/60 to-[#111111]/60 backdrop-blur-lg border border-white/10 shadow-lg text-white mx-auto">
